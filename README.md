...
<br>
Opentofu module to create Networking resources with IPv4 or dual stack IP mode enabled for workload deployment on AWS Cloud.
...
```
Refer [this](https://github.com/atmosly/opentofu-aws-vpc/tree/main/examples) for more examples.


## Important Note
To prevent destruction interruptions, any resources that have been created outside of Opentofu and attached to the resources provisioned by Opentofu must be deleted before the module is destroyed.

The private key generated by Keypair module will be stored in AWS Systems Manager Parameter Store. For more details refer [this](https://github.com/atmosly/opentofu-aws-keypair)
...
- **vpc-peering:** VPC peering support is available using submodule `vpc_peering`. Refer [Peering Docs](https://github.com/atmosly/opentofu-aws-vpc/tree/main/modules/vpc_peering) for more information
  - `accepter_name          = ""`
  - `accepter_vpc_id        = ""`
  - `accepter_vpc_region    = ""`
  - `requester_name         = ""`
...
- **vpc-with-ipv6:** To create VPC with IPv6 support, you only need to enable the parameter `ipv6_enabled`. Rest all the configurations will be taken care by module. Refer for example [vpc-with-ipv6](https://github.com/atmosly/opentofu-aws-vpc/tree/main/examples/vpc-native-ipv6) for more information.
  - `vpc_cidr                = ""`
  - `public_subnet_enabled   = true`
  - `private_subnet_enabled  = true`
  - `database_subnet_enabled = true`
...
# IAM Permissions
The required IAM permissions to create resources from this module can be found [here](https://github.com/atmosly/opentofu-aws-vpc/blob/main/IAM.md)
...
To report an issue with a project:
  ...
  1. Check the repository's [issue tracker](https://github.com/atmosly/opentofu-aws-vpc/issues) on GitHub
...
To support our GitHub project by liking it, you can follow these steps:
  ...
  1. Visit the repository: Navigate to the [GitHub repository](https://github.com/atmosly/opentofu-aws-vpc)
